...
<Note>
If you do not have enough [credits](/essentials/account) then your campaign will end the moment you run out of credits. 
</Note>
9. If you click on the `⟳` button on top, if there have been any calls, the dashboard will get updated with the call details and look like this:
