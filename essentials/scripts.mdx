...
The first part is a set of system intstructions. Here you provide the following key pieces of information:
...
Read more about creating custom conversions [here](/essentials/conversions).